              ...
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    ...
                    onPressed: () => calculatorCtrl.reset(),
                  ),

                  CalculatorButton(
                    text: '+/-',
                    bgColor: Color(0xffA5A5A5 ),
                    onPressed: () => calculatorCtrl.toggleNumberSign(),
                  ),

                  CalculatorButton(
                    text: 'del',
                    bgColor: Color(0xffA5A5A5 ),
                    onPressed: () => calculatorCtrl.removeLastNumber(),
                  ),

                  CalculatorButton(
                    text: '/',
                    bgColor: Color(0xffF0A23B ),
                    onPressed: () => calculatorCtrl.setOperation('/'),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    text: 'X',
                    bgColor: Color(0xffF0A23B ),
                    onPressed: () => calculatorCtrl.setOperation('x'),
                  ),
